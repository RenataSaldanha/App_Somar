    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnSomar.setOnClickListener {
            ...
            if (editPrimeiroNumero.text.toString().isEmpty()) {
                editPrimeiroNumero.error = "Campo obrigatório..."
                editPrimeiroNumero.requestFocus()
            } else if (editSegundoNumero.text.toString().isEmpty()) {
                editSegundoNumero.error = "Campo obrigatório..."
                ...
                txtSomaCalculada.text = soma.toString()
                txtSomatoriaCalculada.text = somatoria.toString()
            }
